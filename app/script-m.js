    ...
    var fragment = document.createDocumentFragment();
      ...
      if (this.readyState == 4 && this.status == 200) {
        ...
        myObj.forEach(function(myObj, index) {
          ...
          document.getElementById('dri-inState').appendChild(label);
          linebreak = document.createElement("br");
          document.getElementById('dri-inState').appendChild(linebreak);
        });
      }
  };
  xmlhttp.open("GET", "http://localhost:8080/driverIn/", true);
  xmlhttp.send();
  // four
    ...
    var fragment = document.createDocumentFragment();
      ...
      if (this.readyState == 4 && this.status == 200) {
        ...
        myObj.forEach(function(myObj, index) {
          ...
          document.getElementById('dri-outState').appendChild(label);
          linebreak = document.createElement("br");
          document.getElementById('dri-outState').appendChild(linebreak);
        });

      }
  };
  xmlhttp.open("GET", "http://localhost:8080/driverOut/", true);
  xmlhttp.send();
