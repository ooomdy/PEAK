...
document.getElementById('n31').addEventListener('click', function(){if($('#n31').hasClass('calendar__green')) {document.getElementById('n31').classList.remove('calendar__green');document.getElementById('n31').classList.add('calendar__red');} else{document.getElementById('n31').classList.remove('calendar__red');document.getElementById('n31').classList.add('calendar__green');}});
